...
module.exports = function(client, config) {
    ...
    me.configure.clickCacheFirstRow = function() {
        var path = '//table[@id=\'ocoins_study_config_table\']/tbody/tr/td/button';
        return client
            .moveToObject(path)
            .click(path)
    ...
    me.configure.filterByName = function(name) {
        var path = '#ocoins_study_config_table_filter input[type=search]';
        return client
            .waitForVis(path)
            .moveToObject(path)
            .setValue(path, name);
    ...
    me.configure.openOcoins = function() {
        var linkPath = '//div[@id="ocoins_study_config_container"]/*/a[contains(., "offline entry")]';
        var config = require('config');
        var nav = require('./nav/navigation.js')(client);
    ...
    me.configure.purgeDbs = function() {
        return client.waitForCondition(function ocoinsDbsPurged() {
            ...
            window.__purgingOcoinsDbs = dbc.clear(true).then(function() {
